...
export const TokenSelector = ({ side }) => {
  ...
  return (
    <div className="min-w-max">
      <label htmlFor={`${side}-token-selector`} className="btn modal-button shadow-inner clip-left min-h-full sm:btn-lg btn-ghost bg-base-200 hover:bg-base-300 rounded-l-none">
